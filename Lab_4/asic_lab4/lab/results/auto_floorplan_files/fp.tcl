################################################################################
#
# Created by fc write_floorplan on Wed Jun  4 14:56:19 2025
#
################################################################################
...
create_site_array -name unit_row -site unit -default -boundary { {10.0000 \
    10.0000} {34.5680 83.2000} } -flip_first_row true -flip_alternate_row true \
...
set track [create_track -layer M1 -count 1260 -dir Y -space 0.0740 -coord \
    0.0100 -bbox {{0.0000 0.0100 } {44.5680 93.1760 }}]
set track [create_track -layer M1 -count 603 -dir X -space 0.0740 -coord 0.0100 \
    -bbox {{0.0100 0.0000 } {44.5580 93.2000 }}]
set track [create_track -layer M2 -count 1553 -dir Y -space 0.0600 -coord \
    0.0400 -bbox {{0.0000 0.0400 } {44.5680 93.1600 }}]
set track [create_track -layer M2 -count 743 -dir X -space 0.0600 -coord 0.0400 \
    -bbox {{0.0400 0.0000 } {44.5600 93.2000 }}]
set track [create_track -layer M3 -count 1260 -dir Y -space 0.0740 -coord \
    0.0100 -bbox {{0.0000 0.0100 } {44.5680 93.1760 }}]
set track [create_track -layer M3 -count 603 -dir X -space 0.0740 -coord 0.0100 \
    -bbox {{0.0100 0.0000 } {44.5580 93.2000 }}]
set track [create_track -layer M4 -count 933 -dir Y -space 0.1000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {44.5680 93.2000 }}]
set track [create_track -layer M4 -count 446 -dir X -space 0.1000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {44.5000 93.2000 }}]
set track [create_track -layer M5 -count 933 -dir Y -space 0.1000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {44.5680 93.2000 }}]
set track [create_track -layer M5 -count 446 -dir X -space 0.1000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {44.5000 93.2000 }}]
set track [create_track -layer M6 -count 933 -dir Y -space 0.1000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {44.5680 93.2000 }}]
set track [create_track -layer M6 -count 446 -dir X -space 0.1000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {44.5000 93.2000 }}]
set track [create_track -layer M7 -count 933 -dir Y -space 0.1000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {44.5680 93.2000 }}]
set track [create_track -layer M7 -count 446 -dir X -space 0.1000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {44.5000 93.2000 }}]
set track [create_track -layer M8 -count 933 -dir Y -space 0.1000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {44.5680 93.2000 }}]
set track [create_track -layer M8 -count 446 -dir X -space 0.1000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {44.5000 93.2000 }}]
set track [create_track -layer M9 -count 933 -dir Y -space 0.1000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {44.5680 93.2000 }}]
set track [create_track -layer M9 -count 446 -dir X -space 0.1000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {44.5000 93.2000 }}]
set track [create_track -layer MRDL -count 23 -dir Y -space 4.0000 -coord \
    2.0000 -bbox {{0.0000 2.0000 } {44.5680 90.0000 }}]
set track [create_track -layer MRDL -count 11 -dir X -space 4.0000 -coord \
    2.0000 -bbox {{2.0000 0.0000 } {42.0000 93.2000 }}]

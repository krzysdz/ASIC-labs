################################################################################
#
# Created by fc write_floorplan on Wed Jun 18 11:05:46 2025
#
################################################################################
...
create_site_array -name unit_row -site unit -default -boundary { {5.0000 \
    5.0000} {53.1000 33.8000} } -flip_first_row true -flip_alternate_row true \
...
set track [create_track -layer M1 -count 524 -dir Y -space 0.0740 -coord 0.0420 \
    -bbox {{0.0000 0.0420 } {58.1000 38.7440 }}]
set track [create_track -layer M1 -count 785 -dir X -space 0.0740 -coord 0.0420 \
    -bbox {{0.0420 0.0000 } {58.0580 38.8000 }}]
set track [create_track -layer M2 -count 647 -dir Y -space 0.0600 -coord 0.0200 \
    -bbox {{0.0000 0.0200 } {58.1000 38.7800 }}]
set track [create_track -layer M2 -count 969 -dir X -space 0.0600 -coord 0.0200 \
    -bbox {{0.0200 0.0000 } {58.1000 38.8000 }}]
set track [create_track -layer M3 -count 524 -dir Y -space 0.0740 -coord 0.0420 \
    -bbox {{0.0000 0.0420 } {58.1000 38.7440 }}]
set track [create_track -layer M3 -count 785 -dir X -space 0.0740 -coord 0.0420 \
    -bbox {{0.0420 0.0000 } {58.0580 38.8000 }}]
set track [create_track -layer M4 -count 389 -dir Y -space 0.1000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {58.1000 38.8000 }}]
set track [create_track -layer M4 -count 582 -dir X -space 0.1000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {58.1000 38.8000 }}]
set track [create_track -layer M5 -count 389 -dir Y -space 0.1000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {58.1000 38.8000 }}]
set track [create_track -layer M5 -count 582 -dir X -space 0.1000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {58.1000 38.8000 }}]
set track [create_track -layer M6 -count 389 -dir Y -space 0.1000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {58.1000 38.8000 }}]
set track [create_track -layer M6 -count 582 -dir X -space 0.1000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {58.1000 38.8000 }}]
set track [create_track -layer M7 -count 389 -dir Y -space 0.1000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {58.1000 38.8000 }}]
set track [create_track -layer M7 -count 582 -dir X -space 0.1000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {58.1000 38.8000 }}]
set track [create_track -layer M8 -count 389 -dir Y -space 0.1000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {58.1000 38.8000 }}]
set track [create_track -layer M8 -count 582 -dir X -space 0.1000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {58.1000 38.8000 }}]
set track [create_track -layer M9 -count 389 -dir Y -space 0.1000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {58.1000 38.8000 }}]
set track [create_track -layer M9 -count 582 -dir X -space 0.1000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {58.1000 38.8000 }}]
set track [create_track -layer MRDL -count 10 -dir Y -space 4.0000 -coord \
    1.0000 -bbox {{0.0000 1.0000 } {58.1000 37.0000 }}]
set track [create_track -layer MRDL -count 15 -dir X -space 4.0000 -coord \
    1.0000 -bbox {{1.0000 0.0000 } {57.0000 38.8000 }}]

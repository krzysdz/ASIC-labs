...
// Generated on 6/11/2025 at 0:18:24
// Library Name: dut_toplevel.dlib
// Block Name: dut_toplevel
// User Label: mcmm_and_logic_opto_full_general
// Write Command: write_verilog /home/student/Documents/kdz/ASIC/labs/Lab_4/asic_lab4/lab/task3/work/../../../lab/results/dut_toplevel_full_logic_opto_full_general.v
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_input_channel_control_1_INST/in_valid_arb_r_reg ( 
    .D ( SEQMAP_NET_574 ) , .SI ( optlc_net_149 ) , .SE ( optlc_net_149 ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_processing_control_INST/proc_req_in_prev_cycle_r_reg ( 
    .D ( proc_req ) , .SI ( optlc_net_149 ) , .SE ( optlc_net_149 ) , 
    .CK ( clk ) , .RD ( nreset ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_fifo_INST/fifo_wptr_r_reg[2] ( 
    .D ( \dut_fifo_INST/fifo_wptr_nxt_c [2] ) , .SI ( optlc_net_168 ) , 
    .SE ( optlc_net_168 ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \math_wrapper_INST/unconsumed_data_r_reg ( 
    .D ( \math_wrapper_INST/unconsumed_data_nxt_c ) , .SI ( optlc_net_157 ) , 
    .SE ( optlc_net_157 ) , .CK ( clk ) , .RD ( HFSNET_10 ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \math_wrapper_INST/new_data_r_reg ( 
    .D ( \math_wrapper_INST/N1 ) , .SI ( optlc_net_157 ) , 
    .SE ( optlc_net_157 ) , .CK ( clk ) , .RD ( HFSNET_10 ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_processing_control_INST/in0_arb_mode_id_en_r_reg[0] ( 
    .D ( proc_req_in0_arb_mode_id[0] ) , .SI ( optlc_net_149 ) , 
    .SE ( optlc_net_149 ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_input_channel_control_0_INST/in_data_last_arb_r_reg ( 
    ...
    .SI ( optlc_net_149 ) , .SE ( optlc_net_149 ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_processing_control_INST/in2_arb_mode_id_en_r_reg[0] ( 
    .D ( proc_req_in2_arb_mode_id[0] ) , .SI ( optlc_net_149 ) , 
    .SE ( optlc_net_149 ) , 
    .CK ( \clk_clock_gate_dut_processing_control_INST/in0_arb_mode_id_en_r_reg ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_processing_control_INST/in0_en_r_reg ( 
    .D ( proc_req_in0_en ) , .SI ( optlc_net_149 ) , .SE ( optlc_net_149 ) , 
    .CK ( \clk_clock_gate_dut_processing_control_INST/in0_arb_mode_id_en_r_reg ) , 
...
SAEDRVT14_TIE0_4 optlc_572 ( .X ( optlc_net_146 ) ) ;
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_input_channel_control_2_INST/in_data_last_arb_r_reg ( 
    ...
    .SI ( optlc_net_157 ) , .SE ( optlc_net_157 ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \math_wrapper_INST/out_data_last_r_reg ( 
    .D ( arb_data_last_c ) , .SI ( optlc_net_168 ) , .SE ( optlc_net_168 ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_arbiter_INST/arb_last_data_source_id_r_reg[1] ( 
    .D ( SEQMAP_NET_453 ) , .SI ( optlc_net_157 ) , .SE ( optlc_net_157 ) , 
    .CK ( clk ) , .RD ( nreset ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_fifo_INST/fifo_data_r_reg[3][26] ( 
    .D ( fifo_wdata_c[26] ) , .SI ( optlc_net_150 ) , .SE ( optlc_net_150 ) , 
    .CK ( \clk_clock_gate_dut_fifo_INST/fifo_data_r_reg_3 ) , 
...
SAEDRVT14_INV_S_0P75 phfnr_buf_412 ( .A ( \dut_fifo_INST/fifo_wptr_r [2] ) , 
    .X ( phfnn_89 ) ) ;
SAEDRVT14_TIE0_4 optlc_573 ( .X ( optlc_net_147 ) ) ;
...
SAEDRVT14_INV_0P5 HFSINV_200_425 ( .A ( arb_data_source_id_c[0] ) , 
    .X ( HFSNET_0 ) ) ;
SAEDRVT14_TIE0_4 optlc_574 ( .X ( optlc_net_148 ) ) ;
SAEDRVT14_INV_0P5 phfnr_buf_420 ( .A ( ctmn_1626 ) , .X ( phfnn_97 ) ) ;
SAEDRVT14_BUF_S_1 HFSBUF_297_426 ( .A ( arb_data_source_id_c[0] ) , 
    .X ( HFSNET_1 ) ) ;
...
SAEDRVT14_TIE0_4 optlc_575 ( .X ( optlc_net_149 ) ) ;
SAEDRVT14_AOI21_0P75 ctmTdsLR_3_443 ( .A1 ( tmp_net103 ) , .A2 ( in1_en_c ) , 
    .B ( tmp_net104 ) , .X ( arb_data_last_c ) ) ;
SAEDRVT14_TIE0_4 optlc_576 ( .X ( optlc_net_150 ) ) ;
SAEDRVT14_TIE0_4 optlc_577 ( .X ( optlc_net_151 ) ) ;
SAEDRVT14_TIE0_4 optlc_578 ( .X ( optlc_net_152 ) ) ;
SAEDRVT14_TIE0_4 optlc_579 ( .X ( optlc_net_153 ) ) ;
SAEDRVT14_TIE0_4 optlc_580 ( .X ( optlc_net_154 ) ) ;
...
SAEDRVT14_TIE0_4 optlc_581 ( .X ( optlc_net_155 ) ) ;
...
SAEDRVT14_TIE0_4 optlc_582 ( .X ( optlc_net_156 ) ) ;
SAEDRVT14_AN4_0P5 ctmi_2100 ( .A1 ( phfnn_85 ) , .A2 ( ctmn_1622 ) , 
    .A3 ( ctmn_1605 ) , .A4 ( in1_en_c ) , .X ( in1_ready ) ) ;
SAEDRVT14_TIE0_4 optlc_583 ( .X ( optlc_net_157 ) ) ;
SAEDRVT14_TIE0_4 optlc_584 ( .X ( optlc_net_158 ) ) ;
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_fifo_INST/fifo_data_r_reg[2][28] ( 
    .D ( fifo_wdata_c[28] ) , .SI ( optlc_net_164 ) , .SE ( optlc_net_165 ) , 
    .CK ( \clk_clock_gate_dut_fifo_INST/fifo_data_r_reg_2 ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_fifo_INST/fifo_data_r_reg[2][26] ( 
    .D ( fifo_wdata_c[26] ) , .SI ( optlc_net_166 ) , .SE ( optlc_net_166 ) , 
    .CK ( \clk_clock_gate_dut_fifo_INST/fifo_data_r_reg_2 ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_fifo_INST/fifo_data_r_reg[2][24] ( 
    .D ( fifo_wdata_c[24] ) , .SI ( optlc_net_166 ) , .SE ( optlc_net_166 ) , 
    .CK ( \clk_clock_gate_dut_fifo_INST/fifo_data_r_reg_2 ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_fifo_INST/fifo_data_r_reg[2][20] ( 
    .D ( fifo_wdata_c[20] ) , .SI ( optlc_net_165 ) , .SE ( optlc_net_165 ) , 
    .CK ( \clk_clock_gate_dut_fifo_INST/fifo_data_r_reg_2 ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_fifo_INST/fifo_data_r_reg[2][17] ( 
    .D ( fifo_wdata_c[17] ) , .SI ( optlc_net_165 ) , .SE ( optlc_net_165 ) , 
    .CK ( \clk_clock_gate_dut_fifo_INST/fifo_data_r_reg_2 ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_fifo_INST/fifo_data_r_reg[2][15] ( 
    .D ( fifo_wdata_c[15] ) , .SI ( optlc_net_163 ) , .SE ( optlc_net_163 ) , 
    .CK ( \clk_clock_gate_dut_fifo_INST/fifo_data_r_reg_2 ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_fifo_INST/fifo_data_r_reg[2][9] ( 
    .D ( fifo_wdata_c[9] ) , .SI ( optlc_net_167 ) , .SE ( optlc_net_167 ) , 
    .CK ( \clk_clock_gate_dut_fifo_INST/fifo_data_r_reg_2 ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_fifo_INST/fifo_data_r_reg[2][1] ( 
    .D ( fifo_wdata_c[1] ) , .SI ( optlc_net_154 ) , .SE ( optlc_net_154 ) , 
    .CK ( \clk_clock_gate_dut_fifo_INST/fifo_data_r_reg_2 ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_fifo_INST/fifo_data_r_reg[1][21] ( 
    .D ( fifo_wdata_c[21] ) , .SI ( optlc_net_164 ) , .SE ( optlc_net_164 ) , 
    .CK ( \clk_clock_gate_dut_fifo_INST/fifo_data_r_reg_1 ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_fifo_INST/fifo_data_r_reg[1][19] ( 
    .D ( fifo_wdata_c[19] ) , .SI ( optlc_net_165 ) , .SE ( optlc_net_165 ) , 
    .CK ( \clk_clock_gate_dut_fifo_INST/fifo_data_r_reg_1 ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_fifo_INST/fifo_data_r_reg[1][16] ( 
    .D ( fifo_wdata_c[16] ) , .SI ( optlc_net_146 ) , .SE ( optlc_net_146 ) , 
    .CK ( \clk_clock_gate_dut_fifo_INST/fifo_data_r_reg_1 ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_fifo_INST/fifo_data_r_reg[1][13] ( 
    .D ( fifo_wdata_c[13] ) , .SI ( optlc_net_146 ) , .SE ( optlc_net_146 ) , 
    .CK ( \clk_clock_gate_dut_fifo_INST/fifo_data_r_reg_1 ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_fifo_INST/fifo_data_r_reg[1][11] ( 
    .D ( fifo_wdata_c[11] ) , .SI ( optlc_net_146 ) , .SE ( optlc_net_146 ) , 
    .CK ( \clk_clock_gate_dut_fifo_INST/fifo_data_r_reg_1 ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_fifo_INST/fifo_data_r_reg[1][6] ( 
    .D ( fifo_wdata_c[6] ) , .SI ( optlc_net_146 ) , .SE ( optlc_net_146 ) , 
    .CK ( \clk_clock_gate_dut_fifo_INST/fifo_data_r_reg_1 ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_fifo_INST/fifo_data_r_reg[0][29] ( 
    .D ( fifo_wdata_c[29] ) , .SI ( optlc_net_156 ) , .SE ( optlc_net_156 ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_fifo_INST/fifo_data_r_reg[0][8] ( 
    .D ( fifo_wdata_c[8] ) , .SI ( optlc_net_154 ) , .SE ( optlc_net_154 ) , 
    .CK ( \clk_clock_gate_dut_fifo_INST/fifo_data_r_reg ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_fifo_INST/fifo_data_r_reg[0][6] ( 
    .D ( fifo_wdata_c[6] ) , .SI ( optlc_net_147 ) , .SE ( optlc_net_147 ) , 
    .CK ( \clk_clock_gate_dut_fifo_INST/fifo_data_r_reg ) , 
...
SAEDRVT14_FSDPRBQ_V2LP_1 \math_wrapper_INST/out_data_source_id_r_reg[1] ( 
    .D ( arb_data_source_id_c[1] ) , .SI ( optlc_net_168 ) , 
    .SE ( optlc_net_168 ) , 
    .CK ( \clk_clock_gate_math_wrapper_INST/out_data_r_reg ) , 
    .RD ( HFSNET_10 ) , .Q ( fifo_wdata_c[1] ) ) ;
SAEDRVT14_FSDPRBQ_V2LP_1 \math_wrapper_INST/out_data_source_id_r_reg[0] ( 
    .D ( HFSNET_1 ) , .SI ( optlc_net_168 ) , .SE ( optlc_net_168 ) , 
    .CK ( \clk_clock_gate_math_wrapper_INST/out_data_r_reg ) , 
    .RD ( HFSNET_10 ) , .Q ( fifo_wdata_c[0] ) ) ;
SAEDRVT14_TIE0_4 optlc_585 ( .X ( optlc_net_159 ) ) ;
SAEDRVT14_TIE0_4 optlc_586 ( .X ( optlc_net_160 ) ) ;
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_input_channel_control_0_INST/in_valid_arb_r_reg ( 
    .D ( SEQMAP_NET_570 ) , .SI ( optlc_net_149 ) , .SE ( optlc_net_149 ) , 
    .CK ( clk ) , .RD ( nreset ) , .Q ( in0_valid_c ) ) ;
SAEDRVT14_TIE0_4 optlc_587 ( .X ( optlc_net_161 ) ) ;
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_input_channel_control_2_INST/in_valid_arb_r_reg ( 
    .D ( SEQMAP_NET_578 ) , .SI ( optlc_net_149 ) , .SE ( optlc_net_149 ) , 
    .CK ( clk ) , .RD ( nreset ) , .Q ( in2_valid_c ) ) ;
SAEDRVT14_TIE0_4 optlc_588 ( .X ( optlc_net_162 ) ) ;
SAEDRVT14_TIE0_4 optlc_589 ( .X ( optlc_net_163 ) ) ;
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_processing_control_INST/proc_ack_r_reg ( 
    .D ( SEQMAP_NET_582 ) , .SI ( optlc_net_149 ) , .SE ( optlc_net_149 ) , 
    .CK ( clk ) , .RD ( nreset ) , .Q ( proc_ack ) ) ;
SAEDRVT14_TIE0_4 optlc_590 ( .X ( optlc_net_164 ) ) ;
SAEDRVT14_TIE0_4 optlc_591 ( .X ( optlc_net_165 ) ) ;
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_output_control_INST/out_last_data_sent_r_reg ( 
    .D ( SEQMAP_NET_586 ) , .SI ( optlc_net_169 ) , .SE ( optlc_net_169 ) , 
    .CK ( \clk_clock_gate_dut_fifo_INST/fifo_rptr_r_reg ) , 
    .RD ( HFSNET_13 ) , .Q ( out_last_data_sent_c ) ) ;
SAEDRVT14_ND2_CDC_1 ctmi_2223 ( .A1 ( ctmn_1605 ) , .A2 ( ctmn_1644 ) , 
    .X ( ctmn_1683 ) ) ;
SAEDRVT14_TIE0_4 optlc_592 ( .X ( optlc_net_166 ) ) ;
SAEDRVT14_TIE0_4 optlc_593 ( .X ( optlc_net_167 ) ) ;
...
SAEDRVT14_INV_0P5 ctmi_2266 ( .A ( \math_wrapper_INST/N1 ) , 
    .X ( ctmn_1685 ) ) ;
SAEDRVT14_TIE0_4 optlc_594 ( .X ( optlc_net_168 ) ) ;
...
SAEDRVT14_TIE0_4 optlc_595 ( .X ( optlc_net_169 ) ) ;
...
SAEDRVT14_OR2_0P75 ctmTdsLR_1_542 ( .A1 ( ctmn_1645 ) , .A2 ( HFSNET_1 ) , 
    .X ( tmp_net143 ) ) ;
SAEDRVT14_NR2_MM_1 ctmi_328 ( .A1 ( phfnn_92 ) , .A2 ( phfnn_93 ) , 
    .X ( ctmn_1630 ) ) ;
SAEDRVT14_INV_S_2 ctmTdsLR_2_543 ( .A ( tmp_net143 ) , 
...
SAEDRVT14_AO21B_0P5 ctmTdsLR_2_545 ( .A1 ( ctmn_1616 ) , 
    .A2 ( in0_data_last_c ) , .B ( in0_en_c ) , .X ( tmp_net145 ) ) ;
...
SAEDRVT14_CKGTPLT_V5_1 \clock_gate_dut_processing_control_INST/in0_arb_mode_id_en_r_reg ( 
    .CK ( clk ) , .EN ( first_cycle_of_proc_req_c ) , .SE ( optlc_net_149 ) , 
...
SAEDRVT14_CKGTPLT_V5_1 \clock_gate_math_wrapper_INST/out_data_r_reg ( 
    .CK ( clk ) , .EN ( \math_wrapper_INST/N1 ) , .SE ( optlc_net_168 ) , 
...
SAEDRVT14_OR4_1 ctmi_2108 ( .A1 ( in2_arb_mode_id_en_c[0] ) , 
    ...
    .X ( ctmn_1626 ) ) ;
SAEDRVT14_ND2_CDC_0P5 ctmTdsLR_3_546 ( .A1 ( tmp_net144 ) , 
    .A2 ( tmp_net145 ) , .X ( tmp_net104 ) ) ;
...
SAEDRVT14_FSDPRBQ_V2LP_1 \dut_input_channel_control_0_INST/in_data_arb_r_reg[35] ( 
    .D ( in0_data[35] ) , .SI ( optlc_net_149 ) , .SE ( optlc_net_149 ) , 
    .CK ( \clk_clock_gate_dut_input_channel_control_0_INST/in_data_arb_r_reg ) , 
...
SAEDRVT14_NR2_2 ctmi_329 ( .A1 ( \dut_fifo_INST/fifo_rptr_r [1] ) , 
